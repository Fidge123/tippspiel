...
export const Legal: FC = () => (
  <article>
    <h1 class="py-2 text-xl font-bold">Legal information</h1>
    <p class="py-2">
    ...
    <p class="py-2">
      This website includes material owned by the National Football League which
      is protected under applicable copyright. This material is used only
      nominatively. This website is neither sponsored nor endorsed by the
      National Football League. This website does not own or claim ownership of
      any names or logos that are registered trademarks of the National Football
      League.
    </p>
    <p class="py-2">
